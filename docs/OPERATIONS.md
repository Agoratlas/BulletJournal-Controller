...
- Offline administrative commands do not require server-only environment
  variables, including `BULLETJOURNAL_PROMETHEUS_API_KEY`.
...
not require it. This also applies to `create-user`, `cleanup-instance`,
