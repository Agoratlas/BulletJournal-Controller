...
def default_instance_config() -> InstanceConfig:
    ...
    return InstanceConfig(
        ...
        default_dependencies_file=str(defaults_root / 'default-dependencies.txt'),
        runtime_dockerfile=str(defaults_root / 'runtime' / 'Dockerfile'),
        runtime_build_context=str(defaults_root),
    )
...
def instance_config_from_dict(data: dict[str, object]) -> InstanceConfig:
    try:
        config = InstanceConfig(
            ...
            default_bulletjournal_version=_required_str(data, 'default_bulletjournal_version'),
