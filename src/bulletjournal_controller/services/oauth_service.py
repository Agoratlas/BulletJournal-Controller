...
class OAuthService:
    ...
    def register_client(self, payload: dict[str, object]) -> dict[str, object]:
        ...
        if (
            ...
            raise ValidationError(
                "redirect_uris must be a non-empty list of exact URIs."
            )
    ...
    def validate_authorization_request(
        ...
        *,
        ...
        if client is None or redirect_uri not in json.loads(
    ...
    def refresh(
        self, refresh_token: str, *, client_id: str, resource: str | None
    ) -> dict[str, object]:
    ...
    def _issue_tokens(
        self, row: dict[str, object], *, family_id: str | None = None
    ) -> dict[str, object]:
