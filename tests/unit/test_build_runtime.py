...
def test_build_runtime_does_not_require_prometheus_api_key(instance_root: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(RuntimeConfigService, 'ensure_runtime_image', ensure_runtime_image)
